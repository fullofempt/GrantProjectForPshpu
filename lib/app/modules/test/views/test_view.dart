...
//         {"question": "5 + 3 = 9?", "answer": false, "image": "assets/math2.png"}
//       ],
//       "Science": [
//         {"question": "Земля круглая?", "answer": true, "image": "assets/science1.png"},
//         {"question": "Солнце вращается вокруг Земли?", "answer": false, "image": "assets/science2.png"}
//       ],
//       "History": [
...
//               child: Text("OK"),
//               onPressed: () {
//                 widget.onComplete(TestResult(widget.child.fullName, widget.category, _correctAnswersCount, now));
//                 Navigator.pop(context);
//                 Navigator.pop(context);
//               },
//             ),
